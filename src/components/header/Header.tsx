...
export const Header = () => {
  ...
  const pages = userType==="admin"? ["subject","user"]:["subject", "result"];
    ...
    <AppBar position="static">
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          ...
          <div style={{ marginRight: 15, fontSize: 16 }}>{"Hi, " + userName + "!"}</div>
          <Box sx={{ flexGrow: 0 }}>
            ...
            >
              {settings.map((setting) => (
                <MenuItem key={setting} onClick={() => onClickMenu(setting)}>
